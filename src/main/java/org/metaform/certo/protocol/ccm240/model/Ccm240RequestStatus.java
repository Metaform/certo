...
/**
 * The {@code requestStatus} values of a legacy v2.4.0 {@code /companycertificate/request} reply. The
 * v3 Fulfillment phase ({@link org.metaform.certo.common.model.FulfillmentStatus}) collapses onto these
 * three: {@code ACKNOWLEDGED}/{@code CERTIFICATION_REQUESTED} &rarr; {@code IN_PROGRESS},
