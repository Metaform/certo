 ...
 */
@Component
public class Ccm240AcceptanceReporter implements ProtocolAcceptanceReporter {
    ...
    public void report(ExchangeBinding binding, String exchangeId, String certificateId,
        ...
        LOG.info("Reported acceptance {} for exchange {} to v2.4.0 provider {} as status {} (delivered: {})",
                status, exchangeId, binding.peerBpn(), legacyStatus, delivered);
    }
