...
import org.metaform.certo.consumer.CertificateConsumerService;
 ...
 */
@RestController
public class CertificateConsumerController {

    private final CertificateConsumerService service;

    public CertificateConsumerController(CertificateConsumerService service) {
